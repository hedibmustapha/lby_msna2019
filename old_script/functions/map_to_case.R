...
list_all_cases<-function(implemented_only=F){
  ...
  if(!implemented_only){
    hypothesis_types<-c("direct_reporting","direct_reporting_median","group_difference","group_difference_median","limit","correlation","change")
...
map_to_case<-function(hypothesis.type,
  ...
  if((hypothesis.type!="direct_reporting" & hypothesis.type!="direct_reporting_median") & is.null(independent.var.type)){
