...
# weighted mean
weighted_mean <- function(x, df, digits = 2, x_name = NULL, group = NULL) {
  if (is.null(x_name)) {
    x_name <- deparse(substitute(x))
  }
  group_var <- group_vars(df)
...
percent_response <- function(x, df, ..., x_name = NULL, group = NULL, digits = 1) {
  if (is.null(x_name)) {
    x_name <- deparse(substitute(x))
  }
  group_var <- group_vars(df)
...
percent_response_01 <- function(x, df, ..., x_name = NULL, group = NULL, digits = 2) {
  if (is.null(x_name)) {
    x_name <- deparse(substitute(x))
  }
  group_var <- group_vars(df)
...
num_percent_response <- function(x, df, ...,x_name = NULL, group = NULL, digits =1) {
  if (is.null(x_name)) {
    x_name <- deparse(substitute(x))
  }
  group_var <- group_vars(df)
