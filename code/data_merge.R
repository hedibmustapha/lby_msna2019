...
dm_file <- dm_data %>%
  summarize(age_hoh = weighted_mean(age_hoh, .),
            male_hoh = percent_response(sex_hoh, ., "male"),
            female_hoh = percent_response(sex_hoh, ., "female"),
            total_people = weighted_sum(size_hh, .),
            size_hh = weighted_mean(size_hh, .),
            infants_female = round( 100 * (weighted_sum(nb_infants_female, .) / total_people), 1),
            children_female = round( 100 * (weighted_sum(nb_children_female, .) / total_people), 1),
            youth_female = round( 100 * (weighted_sum(nb_youth_female, .) / total_people), 1),
            adults_female = round( 100 * (weighted_sum(nb_adults_female, .) / total_people), 1),
            elderly_female = round( 100 * (weighted_sum(nb_elderly_female, .) / total_people), 1),
            infants_male = round( 100 * (weighted_sum(nb_infants_male, .) / total_people), 1),
            children_male = round( 100 * (weighted_sum(nb_children_male, .) / total_people), 1),
            youth_male = round( 100 * (weighted_sum(nb_youth_male, .) / total_people), 1),
            adults_male = round( 100 * (weighted_sum(nb_adults_male, .) / total_people), 1),
            elderly_male = round( 100 * (weighted_sum(nb_elderly_male, .) / total_people), 1),
            ...
            non_displaced_fcs_acceptable = percent_response(filter(., displacement_status == "non_displaced")[["fcs_category"]],
                                                            ...
                                                            "acceptable",
                                                            x_name = "fcs_category"),
            fcs_borderline_or_poor = percent_response(fcs_category,.,"borderline")+ percent_response(fcs_category,.,"poor"),
            ...
            nb_hectares_less_1ha = percent_response(nb_hectares_cultivated_less1ha,.,"yes"),
            ...
            power_cuts = weighted_mean(power_cuts, .),
            ...
            returnee_water_dist_100m = percent_response(filter(.,displacement_status == "returnee")[["distance_drinkingwater"]],
                                                        filter(.,displacement_status == "returnee"),
                                                        "upto_100m",
                                                        x_name = "distance_drinkingwater"),
            returnee_water_dist_200m = percent_response(filter(.,displacement_status == "returnee")[["distance_drinkingwater"]],
                                                        filter(.,displacement_status == "returnee"),
                                                        "between_101_200m",
                                                        x_name = "distance_drinkingwater"),
            returnee_water_dist_300m = percent_response(filter(.,displacement_status == "returnee")[["distance_drinkingwater"]],
                                                        filter(.,displacement_status == "returnee"),
                                                        "between_201_300m",
                                                        x_name = "distance_drinkingwater"),
            returnee_water_dist_400m = percent_response(filter(.,displacement_status == "returnee")[["distance_drinkingwater"]],
                                                        filter(.,displacement_status == "returnee"),
                                                        "between_301_400m",
                                                        x_name = "distance_drinkingwater"),
            returnee_water_dist_500m = percent_response(filter(.,displacement_status == "returnee")[["distance_drinkingwater"]],
                                                        filter(.,displacement_status == "returnee"),
                                                        "between_401_500m",
                                                        x_name = "distance_drinkingwater"),
            returnee_water_dist_more_500m = percent_response(filter(.,displacement_status == "returnee")[["distance_drinkingwater"]],
                                                             filter(.,displacement_status == "returnee"),
                                                             "more_500m",
                                                             x_name = "distance_drinkingwater"),
            idp_water_dist_100m = percent_response(filter(.,displacement_status == "idp")[["distance_drinkingwater"]],
                                                        filter(.,displacement_status == "idp"),
                                                        "upto_100m",
                                                        x_name = "distance_drinkingwater"),
            idp_water_dist_200m = percent_response(filter(.,displacement_status == "idp")[["distance_drinkingwater"]],
                                                        filter(.,displacement_status == "idp"),
                                                        "between_101_200m",
                                                        x_name = "distance_drinkingwater"),
            idp_water_dist_300m = percent_response(filter(.,displacement_status == "idp")[["distance_drinkingwater"]],
                                                        filter(.,displacement_status == "idp"),
                                                        "between_201_300m",
                                                        x_name = "distance_drinkingwater"),
            idp_water_dist_400m = percent_response(filter(.,displacement_status == "idp")[["distance_drinkingwater"]],
                                                        filter(.,displacement_status == "idp"),
                                                        "between_301_400m",
                                                        x_name = "distance_drinkingwater"),
            idp_water_dist_500m = percent_response(filter(.,displacement_status == "idp")[["distance_drinkingwater"]],
                                                        filter(.,displacement_status == "idp"),
                                                        "between_401_500m",
                                                        x_name = "distance_drinkingwater"),
            idp_water_dist_more_500m = percent_response(filter(.,displacement_status == "idp")[["distance_drinkingwater"]],
                                                             filter(.,displacement_status == "idp"),
                                                             "more_500m",
                                                             x_name = "distance_drinkingwater"),
            non_displaced_water_dist_100m = percent_response(filter(.,displacement_status == "non_displaced")[["distance_drinkingwater"]],
                                                   filter(.,displacement_status == "non_displaced"),
                                                   "upto_100m",
                                                   x_name = "distance_drinkingwater"),
            non_displaced_water_dist_200m = percent_response(filter(.,displacement_status == "non_displaced")[["distance_drinkingwater"]],
                                                   filter(.,displacement_status == "non_displaced"),
                                                   "between_101_200m",
                                                   x_name = "distance_drinkingwater"),
            non_displaced_water_dist_300m = percent_response(filter(.,displacement_status == "non_displaced")[["distance_drinkingwater"]],
                                                   filter(.,displacement_status == "non_displaced"),
                                                   "between_201_300m",
                                                   x_name = "distance_drinkingwater"),
            non_displaced_water_dist_400m = percent_response(filter(.,displacement_status == "non_displaced")[["distance_drinkingwater"]],
                                                   filter(.,displacement_status == "non_displaced"),
                                                   "between_301_400m",
                                                   x_name = "distance_drinkingwater"),
            non_displaced_water_dist_500m = percent_response(filter(.,displacement_status == "non_displaced")[["distance_drinkingwater"]],
                                                   filter(.,displacement_status == "non_displaced"),
                                                   "between_401_500m",
                                                   x_name = "distance_drinkingwater"),
            non_displaced_water_dist_more_500m = percent_response(filter(.,displacement_status == "non_displaced")[["distance_drinkingwater"]],
                                                        filter(.,displacement_status == "non_displaced"),
                                                        "more_500m",
                                                        x_name = "distance_drinkingwater"),
            ...
            needed_healthcare_yes = percent_response(healthcare_needed_15days, ., "yes"),
            visited_healthcare_facility_no = percent_response(visited_healthcare_facility, ., "no"),
            ...
            returnee_male_edu = weighted_sum(filter(., displacement_status == "returnee")[["nb_male_edu"]],
                                               filter(., displacement_status == "returnee"),
                                               x_name = "nb_male_edu"),
            returnee_enrolled_male = weighted_sum(filter(., displacement_status == "returnee")[["enrolled_school_male_edu"]],
                                                                    filter(., displacement_status == "returnee"),
                                                                    x_name = "enrolled_school_male_edu"),
            returnee_enrolled_male_pct = round(100 * returnee_enrolled_male / returnee_male_edu, 0),
            returnee_attending_male = weighted_sum(filter(., displacement_status == "returnee")[["attended_school_male"]],
                                                         filter(., displacement_status == "returnee"),
                                                         x_name = "attended_school_male"),
            returnee_attending_male_pct = round(100 * returnee_attending_male / returnee_male_edu, 0),
            returnee_female_edu = weighted_sum(filter(., displacement_status == "returnee")[["nb_female_edu"]],
                                               filter(., displacement_status == "returnee"),
                                               x_name = "nb_female_edu"),
            returnee_enrolled_female = weighted_sum(filter(., displacement_status == "returnee")[["enrolled_school_female_edu"]],
                                                        filter(., displacement_status == "returnee"),
                                                        x_name = "enrolled_school_female_edu"),
            returnee_enrolled_female_pct = round(100 * returnee_enrolled_female / returnee_female_edu, 0),
            returnee_attending_female = weighted_sum(filter(., displacement_status == "returnee")[["attended_school_female"]],
                                                         filter(., displacement_status == "returnee"),
                                                         x_name = "attended_school_female"),
            returnee_attending_female_pct = round(100 * returnee_attending_female / returnee_female_edu, 0),
          
            idp_male_edu = weighted_sum(filter(., displacement_status == "idp")[["nb_male_edu"]],
                                               filter(., displacement_status == "idp"),
                                               x_name = "nb_male_edu"),
            idp_enrolled_male = weighted_sum(filter(., displacement_status == "idp")[["enrolled_school_male_edu"]],
                                                        filter(., displacement_status == "idp"),
                                                        x_name = "enrolled_school_male_edu"),
            idp_enrolled_male_pct = round(100 * idp_enrolled_male / idp_male_edu, 0),
            idp_attending_male = weighted_sum(filter(., displacement_status == "idp")[["attended_school_male"]],
                                                         filter(., displacement_status == "idp"),
                                                         x_name = "attended_school_male"),
            idp_attending_male_pct = round(100 * idp_attending_male / idp_male_edu, 0),
            idp_female_edu = weighted_sum(filter(., displacement_status == "idp")[["nb_female_edu"]],
                                                 filter(., displacement_status == "idp"),
                                                 x_name = "nb_female_edu"),
            idp_enrolled_female = weighted_sum(filter(., displacement_status == "idp")[["enrolled_school_female_edu"]],
                                                          filter(., displacement_status == "idp"),
                                                          x_name = "enrolled_school_female_edu"),
            idp_enrolled_female_pct = round(100 * idp_enrolled_female / idp_female_edu, 0),
            idp_attending_female = weighted_sum(filter(., displacement_status == "idp")[["attended_school_female"]],
                                                           filter(., displacement_status == "idp"),
                                                           x_name = "attended_school_female"),
            idp_attending_female_pct = round(100 * idp_attending_female / idp_female_edu, 0),
      
             non_displaced_male_edu = weighted_sum(filter(., displacement_status == "non_displaced")[["nb_male_edu"]],
                                               filter(., displacement_status == "non_displaced"),
                                               x_name = "nb_male_edu"),
            non_displaced_enrolled_male = weighted_sum(filter(., displacement_status == "non_displaced")[["enrolled_school_male_edu"]],
                                                        filter(., displacement_status == "non_displaced"),
                                                        x_name = "enrolled_school_male_edu"),
            non_displaced_enrolled_male_pct = round(100 * non_displaced_enrolled_male / non_displaced_male_edu, 0),
            non_displaced_attending_male = weighted_sum(filter(., displacement_status == "non_displaced")[["attended_school_male"]],
                                                         filter(., displacement_status == "non_displaced"),
                                                         x_name = "attended_school_male"),
            non_displaced_attending_male_pct = round(100 * non_displaced_attending_male / non_displaced_male_edu, 0),
          
            non_displaced_female_edu = weighted_sum(filter(., displacement_status == "non_displaced")[["nb_female_edu"]],
                                                 filter(., displacement_status == "non_displaced"),
                                                 x_name = "nb_female_edu"),
            non_displaced_enrolled_female = weighted_sum(filter(., displacement_status == "non_displaced")[["enrolled_school_female_edu"]],
                                                          filter(., displacement_status == "non_displaced"),
                                                          x_name = "enrolled_school_female_edu"),
            non_displaced_enrolled_female_pct = round(100 * non_displaced_enrolled_female / non_displaced_female_edu, 0),
            non_displaced_attending_female = weighted_sum(filter(., displacement_status == "non_displaced")[["attended_school_female"]],
                                                           filter(., displacement_status == "non_displaced"),
                                                           x_name = "attended_school_female"),
            non_displaced_attending_female_pct = round(100 * non_displaced_attending_female / non_displaced_female_edu, 0),

            returnee_attendance_issue_1_name = select_percents(filter(., displacement_status =="returnee")[["issues_faced_attending_school"]],
                                                               1,
                                                               filter(., displacement_status =="returnee"),
                                                               questions,
                                                               choices,
                                                               "label",
                                                               x_name = "issues_faced_attending_school"),
            returnee_attendance_issue_1_pct = select_percents(filter(., displacement_status =="returnee")[["issues_faced_attending_school"]],
                                                               1,
                                                               filter(., displacement_status =="returnee"),
                                                               questions,
                                                               choices,
                                                               "percent",
                                                               x_name = "issues_faced_attending_school"),
            returnee_attendance_issue_2_name = select_percents(filter(., displacement_status =="returnee")[["issues_faced_attending_school"]],
                                                               2,
                                                               filter(., displacement_status =="returnee"),
                                                               questions,
                                                               choices,
                                                               "label",
                                                               x_name = "issues_faced_attending_school"),
            returnee_attendance_issue_2_pct = select_percents(filter(., displacement_status =="returnee")[["issues_faced_attending_school"]],
                                                              2,
                                                              filter(., displacement_status =="returnee"),
                                                              questions,
                                                              choices,
                                                              "percent",
                                                              x_name = "issues_faced_attending_school"),
            returnee_attendance_issue_3_name = select_percents(filter(., displacement_status =="returnee")[["issues_faced_attending_school"]],
                                                               3,
                                                               filter(., displacement_status =="returnee"),
                                                               questions,
                                                               choices,
                                                               "label",
                                                               x_name = "issues_faced_attending_school"),
            returnee_attendance_issue_3_pct = select_percents(filter(., displacement_status =="returnee")[["issues_faced_attending_school"]],
                                                              3,
                                                              filter(., displacement_status =="returnee"),
                                                              questions,
                                                              choices,
                                                              "percent",
                                                              x_name = "issues_faced_attending_school"),
            idp_attendance_issue_1_name = select_percents(filter(., displacement_status =="idp")[["issues_faced_attending_school"]],
                                                               1,
                                                               filter(., displacement_status =="idp"),
                                                               questions,
                                                               choices,
                                                               "label",
                                                               x_name = "issues_faced_attending_school"),
            idp_attendance_issue_1_pct = select_percents(filter(., displacement_status =="idp")[["issues_faced_attending_school"]],
                                                              1,
                                                              filter(., displacement_status =="idp"),
                                                              questions,
                                                              choices,
                                                              "percent",
                                                              x_name = "issues_faced_attending_school"),
            idp_attendance_issue_2_name = select_percents(filter(., displacement_status =="idp")[["issues_faced_attending_school"]],
                                                          2,
                                                          filter(., displacement_status =="idp"),
                                                          questions,
                                                          choices,
                                                          "label",
                                                          x_name = "issues_faced_attending_school"),
            idp_attendance_issue_2_pct = select_percents(filter(., displacement_status =="idp")[["issues_faced_attending_school"]],
                                                         2,
                                                         filter(., displacement_status =="idp"),
                                                         questions,
                                                         choices,
                                                         "percent",
                                                         x_name = "issues_faced_attending_school"),
            idp_attendance_issue_3_name = select_percents(filter(., displacement_status =="idp")[["issues_faced_attending_school"]],
                                                          3,
                                                          filter(., displacement_status =="idp"),
                                                          questions,
                                                          choices,
                                                          "label",
                                                          x_name = "issues_faced_attending_school"),
            idp_attendance_issue_3_pct = select_percents(filter(., displacement_status =="idp")[["issues_faced_attending_school"]],
                                                         3,
                                                         filter(., displacement_status =="idp"),
                                                         questions,
                                                         choices,
                                                         "percent",
                                                         x_name = "issues_faced_attending_school"),
            non_displaced_attendance_issue_1_name = select_percents(filter(., displacement_status =="non_displaced")[["issues_faced_attending_school"]],
                                                          1,
                                                          filter(., displacement_status =="non_displaced"),
                                                          questions,
                                                          choices,
                                                          "label",
                                                          x_name = "issues_faced_attending_school"),
            non_displaced_attendance_issue_1_pct = select_percents(filter(., displacement_status =="non_displaced")[["issues_faced_attending_school"]],
                                                         1,
                                                         filter(., displacement_status =="non_displaced"),
                                                         questions,
                                                         choices,
                                                         "percent",
                                                         x_name = "issues_faced_attending_school"),
            non_displaced_attendance_issue_2_name = select_percents(filter(., displacement_status =="non_displaced")[["issues_faced_attending_school"]],
                                                                    2,
                                                                    filter(., displacement_status =="non_displaced"),
                                                                    questions,
                                                                    choices,
                                                                    "label",
                                                                    x_name = "issues_faced_attending_school"),
            non_displaced_attendance_issue_2_pct = select_percents(filter(., displacement_status =="non_displaced")[["issues_faced_attending_school"]],
                                                                   2,
                                                                   filter(., displacement_status =="non_displaced"),
                                                                   questions,
                                                                   choices,
                                                                   "percent",
                                                                   x_name = "issues_faced_attending_school"),
            non_displaced_attendance_issue_3_name = select_percents(filter(., displacement_status =="non_displaced")[["issues_faced_attending_school"]],
                                                                    3,
                                                                    filter(., displacement_status =="non_displaced"),
                                                                    questions,
                                                                    choices,
                                                                    "label",
                                                                    x_name = "issues_faced_attending_school"),
            non_displaced_attendance_issue_3_pct = select_percents(filter(., displacement_status =="non_displaced")[["issues_faced_attending_school"]],
                                                                   3,
                                                                   filter(., displacement_status =="non_displaced"),
                                                                   questions,
                                                                   choices,
  ...
  select(-returnee_adults, -idp_adults, -non_displaced_adults, -returnee_minors, -idp_minors, -non_displaced_minors,
         -total_assistance, -returnee_enrolled_male, -returnee_attending_male,
         -returnee_male_edu,
         -returnee_female_edu, -returnee_enrolled_female, -returnee_attending_female,
         -idp_male_edu, -idp_enrolled_male, -idp_attending_male,
         -idp_female_edu, -idp_enrolled_female, -idp_attending_female,
         -non_displaced_male_edu, -non_displaced_enrolled_male, -non_displaced_attending_male,
         -non_displaced_female_edu, -non_displaced_enrolled_female, -non_displaced_attending_female,
...
mantika_public_network <- dm_data %>%
  group_by(mantika_label) %>%
  summarize(power_cuts = weighted_mean(power_cuts, ., group = !!get_group(.))) %>%
...
mantika_no_visit_healthcare <- dm_data %>%
  group_by(mantika_label) %>%
  summarize(no_visit_healthcare= percent_response(visited_healthcare_facility, .,"no", group = !!get_group(.))) %>%
  arrange(desc(no_visit_healthcare)) %>%
  slice(1:5) %>%
  t

mantika_no_visit_healthcare_row <- tibble(
  no_visit_healthcare_mantika_1_name = mantika_water_insufficient[1,1],
  no_visit_healthcare_mantika_1_pct = mantika_water_insufficient[2,1],
  no_visit_healthcare_mantika_2_name = mantika_water_insufficient[1,2],
  no_visit_healthcare_mantika_2_pct = mantika_water_insufficient[2,2],
  no_visit_healthcare_mantika_3_name = mantika_water_insufficient[1,3],
  no_visit_healthcare_mantika_3_pct = mantika_water_insufficient[2,3],
  no_visit_healthcare_mantika_4_name = mantika_water_insufficient[1,4],
  no_visit_healthcare_mantika_4_pct = mantika_water_insufficient[2,4],
  no_visit_healthcare_mantika_5_name = mantika_water_insufficient[1,5],
  no_visit_healthcare_mantika_5_pct = mantika_water_insufficient[2,5]
)
...
dm_file <- bind_cols( dm_file,
                      ...
                      mantika_no_visit_healthcare_row,
                      mantika_movement_restrictions_row
                      )

write_csv(dm_file, "output/sector_datamerge_17092019.csv")
